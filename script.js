...
let result = (weather === "soleado") ? "Me vestiré con un vestido" : "Me vestiré con un pantalón";
console.log(result)

//Ejercicio 7: cambia el valor de weather a "frío" y mira el resultado en consola para comprobar que tu código funciona bien.

weather = "frio" //Identifier 'weather' has already been declared

result = (weather === "soleado") ? "Me vestiré con un vestido" : "Me vestiré con un pantalón"; // como sustituyo el valor no hay que repetir el LET
console.log(result)
